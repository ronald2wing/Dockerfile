...
# · COMBINATION: Use standalone for complete Flask applications
...
COPY --from=builder --chown=appuser:appgroup /usr/local/lib/python${PYTHON_VERSION}/site-packages /usr/local/lib/python${PYTHON_VERSION}/site-packages
