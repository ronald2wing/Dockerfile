...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# · CATEGORY: Framework
# · PURPOSE: Production-ready Svelte application with security hardening
# · DESIGN PHILOSOPHY: Self-contained with multi-stage builds and security
# · COMBINATION: Use standalone for complete Svelte applications
...
# · OFFICIAL SOURCES: Svelte documentation and Docker security guidelines
...
# docker build --target runtime -t my-svelte-app:prod .

# Example 2: Build development image
# docker build --target development -t my-svelte-app:dev .

# Example 3: Build with custom arguments
# docker build \
#   --build-arg NODE_ENV=production \
#   --build-arg BUILD_ID=$(git rev-parse --short HEAD) \
#   -t my-svelte-app:$(git rev-parse --short HEAD) .

# Example 4: Run production container
# docker run -d -p 3000:3000 --name svelte-app my-svelte-app:prod

# Example 5: Run development container
# docker run -d -p 3000:3000 -v $(pwd):/app --name svelte-dev my-svelte-app:dev
...
# 5. Customize build commands for your Svelte setup
